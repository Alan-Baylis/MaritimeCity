...
namespace DialogueSystems
{
    ...
    public class LukeController : MaritimeRuntimeInfrastructure, ICommunciation
    {

        //InputController NewController;

        static LukeController LukeSingletonObject;
        ...
        public static LukeController LukeInstance
        {

            get { return LukeSingletonObject; }
        ...
        void Awake()
        {
            ...
            LukeSingletonObject = FindObjectOfType<LukeController>();

            LukeDialogueIterator = MaritimeInternalIterator;
