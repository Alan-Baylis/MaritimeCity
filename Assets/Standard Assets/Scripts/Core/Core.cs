...
*/
		...
		public static class CoreEventSystem
		{
			...
			//Struct Object
			public static GUIEvents GUIObject = new GUIEvents ();
			public static SceneEvents SceneObject = new SceneEvents ();
			public static ColliderFunctions ColliderObject = new ColliderFunctions ();
			public static AnimationFunctions AnimationObject = new AnimationFunctions ();
			...
			static void StructInitializers ()
			{
